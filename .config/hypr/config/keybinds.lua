...
-- Switch workspaces and focus on current monitor with mainMod + [0-9]
-- Move active window to a workspace with mainMod + SHIFT + [0-9]
for i = 1, 10 do
	local key = i % 10 -- 10 maps to key 0
	hl.bind(mainMod .. " + SHIFT + " .. key, hl.dsp.window.move({ workspace = i, monitor = "current" }))
	-- Move workspace to current monitor --
	hl.bind(mainMod .. " + " .. key, hl.dsp.workspace.move({ workspace = i, monitor = "current" }))
